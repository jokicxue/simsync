...
| 邮箱服务商 | SMTP 主机 | 端口 | SSL 开关 | 状态与密码要求 |
| :--- | :--- | :---: | :---: | :--- |
| **QQ 邮箱 / Foxmail (推荐)** | `smtp.qq.com` | `465` | **开启** (SSL) | 邮箱网页设置中生成的 **16位专属授权码**（强烈推荐，毫秒级送达） |
| **163 网易邮箱** | `smtp.163.com` | `465` | **开启** (SSL) | 邮箱网页设置中生成的 **客户端授权密码** |
| **Gmail** | `smtp.gmail.com` | `465` | **开启** (SSL) | 谷歌账号生成的 **应用专用密码** (需开启两步验证) |
| **腾讯企业邮** | `smtp.exmail.qq.com` | `465` | **开启** (SSL) | 企业微信/企业邮客户端专用密码 |
| **Office 365 (商业/企业版)** | `smtp.office365.com` | `587` | **关闭** (STARTTLS) | 需管理员在 M365 管理中心开启 Authenticated SMTP |
| **Outlook.com / Hotmail (个人版)** | `smtp-mail.outlook.com` | `587` | - | ❌ **不可用**（微软已于 2024 年 9 月全面封杀 Basic Auth 与应用密码） |

> ⚠️ **关于微软个人版 Outlook / Hotmail 的重要提醒**：  
> 微软官方已于 **2024 年 9 月 16 日全面废除个人账户的“基本身份验证 (Basic Auth)”与“应用密码 (App Passwords)”**，强制推行 OAuth 2.0 现代认证。因此，标准 SMTP 协议已无法使用个人 Outlook 账号作为发信方。  
> 💡 **最佳实践方案（QQ/163 发信，Outlook 接收）**：  
> 发件人推荐配置国内主流的 **QQ 邮箱 (465 SSL)** 或 **163 邮箱**，而在 SimSync 控制台的 **“收件人邮箱” 中填入您的 Outlook 邮箱**。提醒邮件将通过高速通道直接推送到您的 Outlook 手机端与电脑端，稳定省心且无需折腾 OAuth！

> ⚠️ **注意**：国内邮箱（QQ、163 等）均不能使用邮箱的网页日常登录密码，必须在邮箱网页版的“设置 -> 账户 -> POP3/IMAP/SMTP”中生成专门的 **客户端授权码** 作为密码。
